...
from revise.backend.ops.coefficients import compute_autocorr_metrics


class GeneUncertaintyKernel(BaseKernel):
    """
    ...
    def run(self, adata: AnnData, overlap_genes: list):
        ...
        self.logger.info("Done. Results saved to: %s", self.config.result_dir)
